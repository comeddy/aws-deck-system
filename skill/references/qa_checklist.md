...
- [ ] **3. Footer logo**: AWS Smile at `(0.4200", 5.2080", 0.3450"×0.2300")` on every slide.
...
- [ ] **9. Cover anchor compliance**:
  ...
  - Hero logo at `(8.55", 4.45", 1.05"×0.70")`
...
| Footer logo stretched | Check aspect ratio = 1.5:1 (w:h) |
